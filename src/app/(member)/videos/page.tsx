...
export default async function VoyageLibraryPage() {
  ...
  return (
    <div>
      ...
      {/* 検索バー */}
      <form action="/videos/search" method="get" className="mb-6">
        <div className="relative max-w-md">
          ...
          <input
            ...
            name="q"
            placeholder="動画を検索..."
            className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400 bg-white"
          />
        </div>
      </form>
